...
class DelHelperFunctions {
            ...
            return ScaleTransition(
              ...
              child: AlertDialog(
                ...
                content: const Column(
                  ...
                  children: [
                    Text(
                      'The app needs access to your location to provide better services and determine your delivery address',
                      textAlign: TextAlign.right,
                      style: TextStyle(
                        fontSize: 16,
  ...
  static void showAlert({
    ...
    LoggerHelper.info(
        "Displaying AlertDialog: Title - $title, Message - $message"); // Log Alert action
          ...
          actions: [
            if (secondaryButtonText != null)
              TextButton(
                onPressed: secondaryAction ??
                    () {
                      LoggerHelper.info(
                          "Secondary alert button pressed: $secondaryButtonText");
            ...
            ElevatedButton(
              onPressed: primaryAction ??
                  () {
                    LoggerHelper.info(
                        "Primary alert button pressed: ${primaryButtonText ?? 'OK'}");
                    Navigator.of(context).pop();
                  },
              style: ElevatedButton.styleFrom(
  ...
  static void popScreen(BuildContext context) {
    LoggerHelper.info("Closing current screen.");
  ...
  static String truncateText(String text, int maxLength) {
    LoggerHelper.debug("Truncating text to maximum length $maxLength.");
