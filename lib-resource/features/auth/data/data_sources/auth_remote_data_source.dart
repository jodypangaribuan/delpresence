...
import 'package:delcommerce/core/network/dio_client.dart';
import 'package:delcommerce/core/utils/constants/api_constants.dart';
import 'package:delcommerce/core/utils/helpers/dio_exception_helper.dart';
import 'package:delcommerce/core/utils/helpers/platform_exception_helper.dart';
...
import 'package:delcommerce/features/auth/data/models/send_otp_req_body.dart';
import 'package:delcommerce/features/auth/data/models/send_otp_response.dart';
...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<Either<String, RegisterUserData>> register(
    ...
    try {
      ...
      return Left('An unexpected error occurred: $e'); // Arabic for ""
    }
  }
  ...
  Future<Either<String, LoginUserData>> login(
    ...
    try {
      ...
      return Left(
          'An unexpected error occurred: $e'); // Arabic for "An unexpected error occurred"
    }
  }
