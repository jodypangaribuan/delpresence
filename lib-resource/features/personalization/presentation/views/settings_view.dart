...
import 'package:delcommerce/features/personalization/presentation/views/user_addresses_view.dart';
import 'package:delcommerce/features/personalization/presentation/widgets/account_settings_section.dart';
import 'package:delcommerce/features/personalization/presentation/widgets/app_settings_section.dart';
import 'package:delcommerce/features/personalization/presentation/widgets/settings_view_header_section.dart';
import 'package:delcommerce/features/shop/presentation/views/orders_view.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final List<SettingsMenuTileModel> accountSettingsTiles = [
      SettingsMenuTileModel(
        onTap: () {
          ...
          DelHelperFunctions.navigateToScreen(
              context, const UserAddressesView());
        },
        title: "My Addresses",
      ...
      SettingsMenuTileModel(
        onTap: () {
          //navigateToScreen UserAddressesView
          DelHelperFunctions.navigateToScreen(context, const OrdersView());
        },
        title: "My Orders",
